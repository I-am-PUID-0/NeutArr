...
(function(app) {
    if (!app) {
        console.error("NeutArr App core is not loaded!");
        return;
    }
    ...
    const swaparrModule = {
        ...
        setupLogProcessor: function() {
            // Setup a listener for custom event from neutarrUI's log processing
...
})(window.neutarrUI); // Pass the global UI object