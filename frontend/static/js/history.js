...
const historyModule = {
    ...
    init: function() {
        ...
        if (neutarrUI && neutarrUI.currentSection === 'history') {
            this.loadHistory();
        }
    },
    ...
    showError: function(message) {
        // Use neutarrUI's notification system if available
        if (typeof neutarrUI !== 'undefined' && typeof neutarrUI.showNotification === 'function') {
            neutarrUI.showNotification(message, 'error');
        } else {
            alert(message);
        }
    },
...
// Initialize when neutarrUI is ready
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (typeof neutarrUI !== 'undefined') {
        ...
        const originalSwitchSection = neutarrUI.switchSection;
        
        neutarrUI.switchSection = function(section) {
            // Call original function
            originalSwitchSection.call(neutarrUI, section);
