...
const SettingsForms = {
    ...
    generateSonarrForm: function(container, settings = {}) {
        ...
        let searchSettingsHtml = `
            <div class="settings-group">
                ...
                <div class="setting-item">
                    <label for="sonarr-hunt-missing-mode"><span class="info-icon" title="Search by individual episodes, season packs, or full shows"><i class="fas fa-info-circle"></i></span>&nbsp;&nbsp;&nbsp;Missing Search Mode:</label>
                ...
                <div class="setting-item">
                    <label for="sonarr-upgrade-mode"><span class="info-icon" title="Search for quality upgrades by episodes or season packs"><i class="fas fa-info-circle"></i></span>&nbsp;&nbsp;&nbsp;Upgrade Mode:</label>
                ...
                <div class="setting-item">
                    <label for="sonarr-hunt-upgrade-items"><span class="info-icon" title="Number of items to search for quality upgrades per cycle (0 = disabled)"><i class="fas fa-info-circle"></i></span>&nbsp;&nbsp;&nbsp;Upgrade Search:</label>
                ...
                <div class="setting-item">
                    <label for="sonarr_sleep_duration"><span class="info-icon" title="Seconds to wait between search cycles"><i class="fas fa-info-circle"></i></span>&nbsp;&nbsp;&nbsp;Sleep Duration:</label>
    ...
    generateRadarrForm: function(container, settings = {}) {
        ...
        container.innerHTML = `
            ...
            <div class="settings-group">
                <h3>Search Settings</h3>
                <div class="setting-item">
                    <label for="radarr_hunt_missing_movies"><span class="info-icon" title="Number of missing movies to search per cycle (0 = disabled)"><i class="fas fa-info-circle"></i></span>&nbsp;&nbsp;&nbsp;Missing Search:</label>
                ...
                <div class="setting-item">
                    <label for="radarr_hunt_upgrade_movies"><span class="info-icon" title="Number of movies to search for quality upgrades per cycle (0 = disabled)"><i class="fas fa-info-circle"></i></span>&nbsp;&nbsp;&nbsp;Upgrade Search:</label>
                ...
                <div class="setting-item">
                    <label for="radarr_sleep_duration"><span class="info-icon" title="Seconds to wait between search cycles"><i class="fas fa-info-circle"></i></span>&nbsp;&nbsp;&nbsp;Sleep Duration:</label>
    ...
    generateLidarrForm: function(container, settings = {}) {
        ...
        container.innerHTML = `
            ...
            <div class="settings-group">
                <h3>Search Settings</h3>
                <div class="setting-item">
                    <label for="lidarr_hunt_missing_mode"><span class="info-icon" title="Search strategy for finding missing albums"><i class="fas fa-info-circle"></i></span>&nbsp;&nbsp;&nbsp;Missing Search Mode:</label>
                ...
                <div class="setting-item">
                    <label for="lidarr_hunt_missing_items"><span class="info-icon" title="Number of missing albums to search per cycle (0 = disabled)"><i class="fas fa-info-circle"></i></span>&nbsp;&nbsp;&nbsp;Missing Search:</label>
                ...
                <div class="setting-item">
                    <label for="lidarr_hunt_upgrade_items"><span class="info-icon" title="Number of albums to search for quality upgrades per cycle (0 = disabled)"><i class="fas fa-info-circle"></i></span>&nbsp;&nbsp;&nbsp;Upgrade Search:</label>
                ...
                <div class="setting-item">
                    <label for="lidarr_sleep_duration"><span class="info-icon" title="Seconds to wait between search cycles"><i class="fas fa-info-circle"></i></span>&nbsp;&nbsp;&nbsp;Sleep Duration:</label>
    ...
    generateSwaparrForm: function(container, settings = {}) {
        ...
        fetch('/api/swaparr/status')
            ...
            .catch(error => {
                ...
                statusContainer.innerHTML = `<p>Error fetching status: ${NeutArrUtils.escapeHtml(error.message)}</p>`;
            });
        ...
        if (resetStrikesBtn) {
            resetStrikesBtn.addEventListener('click', function() {
                if (confirm('Are you sure you want to reset all Swaparr strikes? This will clear the strike history for all apps.')) {
                    ...
                    .then(data => {
                        if (data.success) {
                            statusContainer.innerHTML = `<p>Success: ${NeutArrUtils.escapeHtml(data.message)}</p>`;
                            ...
                            statusContainer.innerHTML = `<p>Error: ${NeutArrUtils.escapeHtml(data.message)}</p>`;
                        }
                    })
                    .catch(error => {
                        statusContainer.innerHTML = `<p>Error resetting strikes: ${NeutArrUtils.escapeHtml(error.message)}</p>`;
                    });
                }
            });
            ...
            console.warn('Could not find #reset_swaparr_strikes to attach listener.');
             ...
             console.warn('neutarrUI or neutarrUI.resetStatefulManagement is not available.');
        }
        ...
        if (localAccessBypassCheckbox) {
            ...
            localAccessBypassCheckbox.addEventListener('change', function() {
                ...
                if (typeof neutarrUI !== 'undefined' && typeof neutarrUI.updateUIForLocalAccessBypass === 'function') {
                    neutarrUI.updateUIForLocalAccessBypass(newState);
                }
                // Also ensure the main app knows settings have changed if the preview runs
                if (typeof neutarrUI !== 'undefined' && typeof neutarrUI.markSettingsAsChanged === 'function') {
                     neutarrUI.markSettingsAsChanged();
                }
            });
        }
    },
    ...
    generateGeneralForm: function(container, settings = {}) {
        ...
        // Skip loading if neutarrUI has already loaded this data to prevent flashing
        if (window.neutarrUI && window.neutarrUI._cachedStatefulData) {
            console.log('[SettingsForms] Using existing neutarrUI cached stateful data');
        ...
        fetch('/api/stateful/info', {
            ...
            .then(data => {
                ...
                if (window.neutarrUI) {
                    window.neutarrUI._cachedStatefulData = data;
                }
            })
            .catch(error => {
    ...
    testConnection: function(app, url, apiKey, buttonElement) {
        ...
        if (window.neutarrUI && window.neutarrUI.suppressUnsavedChangesCheck) {
            window.neutarrUI.suppressUnsavedChangesCheck = true;
        }
    ...
    _resetSuppressionFlags: function() {
        ...
        if (window.neutarrUI) {
            window.neutarrUI.suppressUnsavedChangesCheck = false;
        }
