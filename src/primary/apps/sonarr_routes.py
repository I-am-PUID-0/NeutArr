...
def test_connection():
    ...
    try:
        ...
        if "Connection refused" in error_details:
            error_msg = "Connection refused - Sonarr may not be running or the port may be incorrect."
            ...
            error_msg = "Connection error - Check if Sonarr is running and reachable."
