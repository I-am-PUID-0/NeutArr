...
def check_connection(api_url: str, api_key: str, api_timeout: int) -> bool:
    ...
    try:
        ...
        # Add User-Agent header to identify NeutArr
        headers = {"X-Api-Key": api_key, "User-Agent": "NeutArr/1.0 (https://github.com/I-am-PUID-0/NeutArr)"}
...
def arr_request(
    ...
    # Set up headers
    headers = {"X-Api-Key": key, "Content-Type": "application/json", "User-Agent": f"NeutArr/1.0 ({app_type})"}
...
def get_cutoff_unmet_books(
    api_url: Optional[str] = None, api_key: Optional[str] = None, api_timeout: Optional[int] = None
) -> List[Dict]:
    """
...
def refresh_author(
    author_id: int, api_url: Optional[str] = None, api_key: Optional[str] = None, api_timeout: Optional[int] = None
) -> bool:
    """
...
def book_search(
    book_ids: List[int], api_url: Optional[str] = None, api_key: Optional[str] = None, api_timeout: Optional[int] = None
) -> bool:
    """
    ...
    response = arr_request(
        endpoint, method="POST", data=data, api_url=api_url, api_key=api_key, api_timeout=api_timeout
    )
