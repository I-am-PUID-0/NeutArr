...
# Set up logging
logger = logging.getLogger("neutarr.instance_list_generator")
...
def generate_instance_list():
    ...
    app_order = {"sonarr": 1, "radarr": 2, "readarr": 3, "lidarr": 4, "whisparr": 5, "eros": 6}
    ...
    app_display_names = {"whisparr": "WhisparrV2", "eros": "WhisparrV3"}
