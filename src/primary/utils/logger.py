#!/usr/bin/env python3
"""
Logging configuration for NeutArr
...
MAIN_LOG_FILE = LOG_DIR / "neutarr.log"
...
def setup_main_logger(debug_mode=None):
    """Set up the main NeutArr logger."""
    global logger
    log_name = "neutarr"
...
def get_logger(app_type: str) -> logging.Logger:
    ...
    # Prevent propagation to the main 'neutarr' logger or root logger
