#!/usr/bin/env python3
"""
State management module for NeutArr
        ...
        if os.path.exists(filepath):
            with open(filepath, "r") as f:
                ...
                if isinstance(loaded_data, list):
                    ...
                    logger.error(
                        f"Invalid data type loaded from {filepath}. Expected list, got {type(loaded_data)}. Returning empty list."
                    )
                    return []
        return []
